...
- 2019: TEI Boilerplate заменён на [CETEIcean](https://github.com/TEIC/CETEIcean);
  ...
  - фотографии документов из РГИА, которые предоставили Константин Пименов и Daria Dubkova;
...
- `Дела`: на список всех дел (по архивам);
- `Имена`: на список имён людей, мест и организаций упомянутых в документах;
- `Blog`: на объявления о происходящем на сайте;
