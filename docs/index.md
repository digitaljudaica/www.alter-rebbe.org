...
- 1991: Любавичским Ребе было дано устное указание искать документы в архиве Петропавловской крепости.
  Как стало известно от одного из хасидов Петербурга (Авигдор Парнас) в 80-е годы в Ленинград приезжал
...
ВОПРОСЫ: какова полная ссылка на эту публикацию? знал ли он о том, что ты нашёл документы в РГАДА?
...
ВОПРОСЫ: кому (и с чего) переводил Ифрах Абрамов?

- 2014: Мегилат Алтер Ребе. 19 Кислев. Полный сборник долументов, историй, протокол допросов.
  Публикуется впервые. Санкт-Петербург, 2014. Составитель Ф.М.Абрамов
...
- 2019: Опубликованы расшифровки документов которые предоставили Илья Лурье и Ифрах Абрамов; начата работа по тагизации;
  TEI Boilerplate заменён на [CETEIcean](https://github.com/TEIC/CETEIcean); улучшена навигация и стилизация;
