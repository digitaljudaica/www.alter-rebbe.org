...
интерпретация документов в наши цели не входит, но побочным продуктом нашего проeкта является увеличение осмысленности
...
- вернуть имеющимся транскриптам, порождённым предидущими проeктами в этой области (и доступным нам)
