...
- название (`title`); содержит заголовок документа (если он есть);
- краткое содержание (`abstract`);
- автор (`author`);
- расшифровщик (`editor` с `role` `transcriber`);
- дата написания (`date` внутри `creation`):
  ...
  <teiHeader>
    <fileDesc>
      <titleStmt>
        ...
        <editor role="transcriber"><persName ref="#IA">Ифрах Абрамов</persName></editor>
      </titleStmt>
      ...
    </fileDesc>
    <profileDesc>
      ...
      <creation>
        <date when="1798-05-08">8 мая 1798</date>
      </creation>
      <abstract>
        <p>Донос</p>
      </abstract>
