...
и идентифицировал авторов некоторых из них.
...
Техническую поддержку сайта осушествляет Арье-Лейб Дубинский.
Исходный код доступен в [GitHub](https://github.com/alter-rebbe/site);
сайт публикуется с испольованием [GitHub Pages](https://pages.github.com/).  
